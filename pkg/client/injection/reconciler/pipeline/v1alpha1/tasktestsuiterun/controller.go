...
import (
	...
	tasktestsuiterun "github.com/tektoncd/pipeline/pkg/client/injection/informers/pipeline/v1alpha1/tasktestsuiterun"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "tasktestsuiterun-controller"
	defaultFinalizerName       = "tasktestsuiteruns.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	tasktestsuiterunInformer := tasktestsuiterun.Get(ctx)

	lister := tasktestsuiterunInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "tekton.dev.TaskTestSuiteRun"),
	)
