...
import (
	...
	tasktestrun "github.com/tektoncd/pipeline/pkg/client/injection/informers/pipeline/v1alpha1/tasktestrun"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "tasktestrun-controller"
	defaultFinalizerName       = "tasktestruns.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	tasktestrunInformer := tasktestrun.Get(ctx)

	lister := tasktestrunInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "tekton.dev.TaskTestRun"),
	)
