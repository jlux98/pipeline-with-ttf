...
import (
	...
	tasktestsuite "github.com/tektoncd/pipeline/pkg/client/injection/informers/pipeline/v1alpha1/tasktestsuite"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "tasktestsuite-controller"
	defaultFinalizerName       = "tasktestsuites.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	tasktestsuiteInformer := tasktestsuite.Get(ctx)

	lister := tasktestsuiteInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "tekton.dev.TaskTestSuite"),
	)
