...
import (
	...
	tasktest "github.com/tektoncd/pipeline/pkg/client/injection/informers/pipeline/v1alpha1/tasktest"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "tasktest-controller"
	defaultFinalizerName       = "tasktests.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	tasktestInformer := tasktest.Get(ctx)

	lister := tasktestInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "tekton.dev.TaskTest"),
	)
